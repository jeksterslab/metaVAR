...
#'
#' @param y R object.
#'   - Object of class `metavarctvar`.
#'   - Object of class `metavardtvar`.
#'   - Object of class `list`
#'     each element of which is a numeric vector
...
#' @author Ivan Jacob Agaloos Pesigan
#'
#' @param y Object of class `metavarctvar`.
#' @param mu_start Numeric matrix.
#'   Matrix of starting values of `mu`.
#' @param sigma_l_start Numeric matrix.
#'   Matrix of starting values of `t(chol(sigma))`.
