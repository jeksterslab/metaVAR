...
#> [1] fitDTVARMx_0.0.0.9000    metaVAR_0.0.0.9000       fitCTVARMx_0.0.0.9000   
#> [4] OpenMx_2.21.11           simStateSpace_1.2.2.9000
#> 
#> loaded via a namespace (and not attached):
#>  [1] digest_0.6.36       numDeriv_2016.8-1.1 xfun_0.46          
#>  [4] Matrix_1.7-0        lattice_0.22-6      glue_1.7.0         
#>  [7] knitr_1.48          parallel_4.4.1      RcppParallel_5.1.8 
#> [10] lifecycle_1.0.4     cli_3.6.3.9000      rProject_0.0.14    
#> [13] grid_4.4.1          compiler_4.4.1      highr_0.11         
#> [16] tools_4.4.1         evaluate_0.24.0     Rcpp_1.0.13        
#> [19] rlang_1.1.4         MASS_7.3-60.2
```
...
#> Mem:           125Gi       3.2Gi        59Gi       4.7Gi        62Gi       116Gi
#> Swap:             0B          0B          0B
#> Total:         125Gi       3.2Gi        59Gi
```
