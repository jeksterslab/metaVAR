...
#> [1] metaVAR_0.0.0.9000    fitDTVARMx_0.0.0.9000 OpenMx_2.21.13       
#> [4] simStateSpace_1.2.11 
#> 
#> loaded via a namespace (and not attached):
#>  [1] digest_0.6.37       xfun_0.52           Matrix_1.7-3       
#>  [4] lattice_0.22-6      glue_1.8.0          knitr_1.50         
#>  [7] parallel_4.5.0      RcppParallel_5.1.10 lifecycle_1.0.4    
#> [10] cli_3.6.5.9000      rProject_0.0.18     grid_4.5.0         
#> [13] compiler_4.5.0      tools_4.5.0         evaluate_1.0.3     
#> [16] Rcpp_1.0.14         rlang_1.1.6         MASS_7.3-65
```
...
#> Mem:           251Gi        10Gi       108Gi       5.3Gi       139Gi       241Gi
#> Swap:             0B          0B          0B
#> Total:         251Gi        10Gi       108Gi
```
