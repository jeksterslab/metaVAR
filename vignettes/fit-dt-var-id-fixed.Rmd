...
#> Running Model with 6 parameters
#> 
#>  Lowest minimum so far:  171.786802011745
#> 
#> Solution found
```
...
```
#> 
#>  Solution found!  Final fit=171.7868 (started at 311571.58)  (1 attempt(s): 1 valid, 0 errors)
#>  Start values from best fit:
#> 0.223121884460189,-0.00920588397041373,-0.00400641582512222,0.214566975207131,2.9944766863646,2.06690930331645
summary(meta)
#>          est     se       z      p    2.5%  97.5%
#> b0_1  0.2231 0.0138 16.2088 0.0000  0.1961 0.2501
#> b0_2 -0.0092 0.0110 -0.8402 0.4008 -0.0307 0.0123
#> b0_3 -0.0040 0.0096 -0.4158 0.6775 -0.0229 0.0149
#> b0_4  0.2146 0.0130 16.5244 0.0000  0.1891 0.2400
#> b0_5  2.9945 0.0451 66.3377 0.0000  2.9060 3.0829
#> b0_6  2.0669 0.0380 54.4191 0.0000  1.9925 2.1414
```
