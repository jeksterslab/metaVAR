...
head(data)
#>   id time         y1         y2
#> 1  1    0 -0.2826487 -0.4032862
#> 2  1    1  4.7613668  0.1714329
#> 3  1    2  4.1256231  1.4049857
#> 4  1    3  4.8376927  2.6579244
#> 5  1    4  2.3087179  0.2121804
#> 6  1    5  3.3357857  1.9931660
plot(sim)
```
...
#> Running Model with 6 parameters
#> 
#>  Lowest minimum so far:  4870.52824456257
#> 
#> Solution found
```
...
```
#> 
#>  Solution found!  Final fit=4870.5282 (started at 13061341)  (1 attempt(s): 1 valid, 0 errors)
#>  Start values from best fit:
#> 0.286799923809201,0.0371078632607097,-0.00732336101563466,0.125108420234586,2.73668780731017,2.11126420064013
summary(meta)
#>          est     se        z p    2.5%   97.5%
#> b0_1  0.2868 0.0024 120.7235 0  0.2821  0.2915
#> b0_2  0.0371 0.0016  22.5246 0  0.0339  0.0403
#> b0_3 -0.0073 0.0015  -4.8662 0 -0.0103 -0.0044
#> b0_4  0.1251 0.0024  52.2532 0  0.1204  0.1298
#> b0_5  2.7367 0.0076 361.8596 0  2.7219  2.7515
#> b0_6  2.1113 0.0061 343.5705 0  2.0992  2.1233
```
