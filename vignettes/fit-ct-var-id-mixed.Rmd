---
title: "Multivariate Meta-Analysis of Continuous-Time VAR Estimates (Mixed-Effects Model)"
...
vignette: >
  %\VignetteIndexEntry{Multivariate Meta-Analysis of Continuous-Time VAR Estimates (Mixed-Effects Model)}
...
<img src="fig-vignettes-fit-ct-var-id-mx-mixed-no-error-1.png" width="3300" /><img src="fig-vignettes-fit-ct-var-id-mx-mixed-no-error-2.png" width="3300" /><img src="fig-vignettes-fit-ct-var-id-mx-mixed-no-error-3.png" width="3300" />
...
<img src="fig-vignettes-fit-ct-var-id-mx-mixed-error-1.png" width="3300" /><img src="fig-vignettes-fit-ct-var-id-mx-mixed-error-2.png" width="3300" /><img src="fig-vignettes-fit-ct-var-id-mx-mixed-error-3.png" width="3300" />
...
#> -4.329355e+03  9.046809e+02  1.743436e+03 -1.440602e+03 -1.794568e+03 
#>        phi_32        phi_13        phi_23        phi_33      sigma_11 
#>  1.954907e+03 -1.227965e+03 -2.406786e+03 -2.098784e+03  9.321935e-02 
#>      sigma_22      sigma_33      theta_11      theta_22      theta_33 
#>  9.769006e-02  8.543894e-02  1.655056e-02  3.753172e-02  8.739916e-03
```
...
#> Error in if (fu %in% c("-2lnL", "r'Wr", "r'wr")) {: argument is of length zero
summary(meta)
